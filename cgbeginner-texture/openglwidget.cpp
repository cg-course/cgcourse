...
void OpenGLWidget::initializeGL()
{
    ...
    m_cat = new QOpenGLTexture (QImage(":/cat.jpg"));
    m_cat->setMagnificationFilter(QOpenGLTexture::Linear);
    m_cat->setMinificationFilter(QOpenGLTexture::Linear);
...
void OpenGLWidget::paintGL()
{
    ...
    m_cat->bind(1);
    m_basicShaderProgram->setUniformValue("cat", 1);
    m_basicShaderProgram->setUniformValue("time", (float) m_time);
